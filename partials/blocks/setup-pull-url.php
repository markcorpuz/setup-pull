...
if( $showsource == 'show' && is_user_logged_in() && is_array( $out ) ) {
	...
	$replace_array = array(
				...
				'{@group_start}'		=> '<div class="fontsize-smaller">
												<span class="fontsize-tiny" style="background-color: red;color:#fff;padding:2px 5px;border-radius:5px;font-weight:600;margin-right:0.5rem;">START</span>
												'.$timestamp.'
												&nbsp;'.$this_url.'
												&nbsp;'.$link_stamp.'
											</div>',
				'{@group_end}'			=> '<div class="fontsize-smaller">
												<span class="fontsize-tiny" style="background-color: red;color:#fff;padding:2px 5px;border-radius:5px;font-weight:600;margin-right:0.5rem;">END</span>
												'.$link_stamp.'
											</div>',
			);
